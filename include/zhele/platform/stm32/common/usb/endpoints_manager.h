...
namespace Zhele::Usb
{
    ...
    */
    ...
    public:
        ...
        */
        ...
        static consteval auto GetBufferOffset() {
            return GetBufferOffset(template_utils::type_box<Endpoint>{});
        }
        ...
        */
        ...
        static consteval auto GetPacketDescriptorOffset() {
            return GetPacketDescriptorOffset(template_utils::type_box<Endpoint>{});
        }
    };
    ...
    public:
        ...
        */
        ...
        static consteval auto GetRegisterNumber() {
            return GetRegisterNumber(template_utils::type_box<Endpoint>{});
        }
        ...
        */
        ...
        {
            return _endpointRegs.template get<GetRegisterNumber(template_utils::type_box<Endpoint>{})>();
        }
    };
    // deduction guide for OffsetCalculator
    template<typename... Endpoints>
    EndpointRegistersManager(template_utils::type_list<Endpoints...> endpoints) -> EndpointRegistersManager<Endpoints...>;
    ...
    class EndpointsManager
    {
        ...
        static constexpr auto _sortedUniqueEndpoints = template_utils::type_list<Endpoints...>{}.remove_duplicates().sort([](auto first, auto second){ return first.Number < second.Number; });
        /// EPRn manager
        ...
        */
        ...
        template<typename Endpoint>
        static constexpr uint32_t BufferOffset = GetBufferOffset(template_utils::type_box<Endpoint>{});
        ...
        */
        ...
        template<typename Endpoint>
        static const uint32_t BdtCellOffset = GetBdtCellOffset(template_utils::type_box<Endpoint>{});
        ...
        */
        ...
        static consteval auto GetEndpointInReg() {
            if constexpr (Number == -1)
                return template_utils::type_box<void>{};
            else
        ...
        using ExtendEndpoint = 
            typename std::conditional_t<Endpoint::Direction == EndpointDirection::Bidirectional,
                BidirectionalEndpoint<
                    Endpoint,
                    template_utils::type_unbox<_registersManager.template GetEndpointInReg<Endpoint::Number>()>, // IN register
                    template_utils::type_unbox<_registersManager.template GetEndpointOutReg<Endpoint::Number>()>, // OUT register
    ...
    EndpointsManager(template_utils::type_list<Ep...> endpoints) -> EndpointsManager<Ep...>;
    ...
    class EndpointHandlers
    {
         ...
         * 
         * @details I have been use template_utils::type_unbox<> for parameters because on element of Endpoints
         *  is Typebox without inherit - it is template_utils::type_box<DeviceBase<XXX>>, where DeviceBase<XXX> is incomplete type 
         * 
         * @returns std::array with indexes
        */
        static consteval auto BuildIndexesArray()
        {
            constexpr auto endpoints = template_utils::type_list<Endpoints...>{};
            constexpr auto maxEndpointsNumber = template_utils::type_unbox<endpoints.sort([](auto a, auto b) {
                return template_utils::type_unbox<a>::Number < template_utils::type_unbox<b>::Number;
            }).back()>::Number;
            ...
            endpoints.foreach([&indexes, i{0}](auto endpoint) mutable {
                if (template_utils::type_unbox<endpoint>::Direction == EndpointDirection::In || template_utils::type_unbox<endpoint>::Direction == EndpointDirection::Bidirectional)
                    indexes[2 * template_utils::type_unbox<endpoint>::Number] = i;
                if (template_utils::type_unbox<endpoint>::Direction == EndpointDirection::Out || template_utils::type_unbox<endpoint>::Direction == EndpointDirection::Bidirectional)
                    indexes[1 + 2 * template_utils::type_unbox<endpoint>::Number] = i;
                ++i;
            });
    ...
    public:
        ...
        template<typename... Ep>
        constexpr EndpointHandlers(template_utils::type_list<Ep...> endpoints) {}
    ...
    class EndpointFifoNotEmptyHandlers
    {
        ...
        */
        static consteval auto BuildIndexesArray()
        {
            constexpr auto outEndpoints = template_utils::type_list<OutEndpoints...>{};

            constexpr auto maxEndpointNumber = outEndpoints.sort([](auto a, auto b) { return template_utils::type_unbox<a>::Number < template_utils::type_unbox<b>::Number; }).back().Number;
            ...
            outEndpoints.foreach([&indexes, i{0}](auto endpoint) mutable {
                indexes[template_utils::type_unbox<endpoint>::Number] = i++;
            });
