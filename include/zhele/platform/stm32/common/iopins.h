...
#ifndef ZHELE_PLATFORM_STM32_COMMON_IOPINS_H
#define ZHELE_PLATFORM_STM32_COMMON_IOPINS_H
...
\
    ...
    #else
        DECLARE_PORT_PINS(NullPort, Pd)
    #endif

    #if defined (GPIOE)
        DECLARE_PORT_PINS(Porte, Pe)
    #else
        DECLARE_PORT_PINS(NullPort, Pe)
    #endif

    #if defined (GPIOF)
        DECLARE_PORT_PINS(Portf, Pf)
    #else
        DECLARE_PORT_PINS(NullPort, Pf)
    #endif
