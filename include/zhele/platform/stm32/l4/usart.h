...
#ifndef ZHELE_PLATFORM_STM32_L4_USART_H
#define ZHELE_PLATFORM_STM32_L4_USART_H
        ...
        */
        ...
        void Usart<_Regs, _IRQNumber, _ClockCtrl, _TxPins, _RxPins, _DmaTx, _DmaRx>::SelectTxRxPins()
        {
            ...
            if constexpr(RxPinNumber != -1)
            {
                ...
                RxPin::SetConfiguration(RxPin::Port::Configuration::AltFunc);
...
#endif //! ZHELE_PLATFORM_STM32_L4_USART_H