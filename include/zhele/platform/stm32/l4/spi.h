...
#ifndef ZHELE_PLATFORM_STM32_L4_SPI_H
#define ZHELE_PLATFORM_STM32_L4_SPI_H
    ...
    namespace Private
    {
        ...
        void Spi<_Regs, _Clock, _MosiPins, _MisoPins, _ClockPins, _SsPins, _DmaTx, _DmaRx>::SelectPins(int8_t mosiPinNumber, int8_t misoPinNumber, int8_t clockPinNumber, int8_t ssPinNumber)
        {
            ...
            if(mosiPinNumber != -1)
            {
                ...
                _MosiPins::SetConfiguration(_MosiPins::Configuration::AltFunc, maskMosi);
            ...
            if(misoPinNumber != -1)
            {
                ...
                _MisoPins::SetConfiguration(_MisoPins::Configuration::AltFunc, maskMiso);
                _MisoPins::AltFuncNumber(GetAltFunctionNumber<_Regs>, maskMiso);
            }

            _ClockPins::Enable();
            Type maskClock(1 << clockPinNumber);
            _ClockPins::SetConfiguration(_ClockPins::Configuration::AltFunc, maskClock);
            ...
            if(ssPinNumber != -1)
            {
                ...
                _SsPins::SetConfiguration(_SsPins::Configuration::AltFunc, maskSs);
...
#endif //! ZHELE_PLATFORM_STM32_L4_SPI_H