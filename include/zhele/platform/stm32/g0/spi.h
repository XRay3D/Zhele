...
namespace Zhele
{
    namespace Private
    {
        ...
        struct Spi1SsPins
        {
            ...
            static constexpr ArrayU8 alt_functions{0, 0, 0, 1};
        };
