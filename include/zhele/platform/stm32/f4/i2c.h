...
#ifndef ZHELE_PLATFORM_STM32_F4_I2C_H
#define ZHELE_PLATFORM_STM32_F4_I2C_H
...
namespace Zhele
{
    namespace Private
    {
        ...
        void I2C_TEMPLATE_QUALIFIER::SelectPins(uint8_t sclPinNumber, uint8_t sdaPinNumber)
        {
            ...
            _SclPins::SetConfiguration(_SclPins::Configuration::AltFunc, maskScl);
            _SclPins::AltFuncNumber(GetAltFunctionNumber<_Regs>, maskScl);
            _SclPins::SetDriverType(_SclPins::DriverType::OpenDrain, maskScl);
            _SclPins::SetPullMode(_SclPins::PullMode::PullUp, maskScl);

            _SdaPins::Enable();
            Type maskSda(1 << sdaPinNumber);
            _SdaPins::SetConfiguration(_SdaPins::Configuration::AltFunc, maskSda);
            _SdaPins::AltFuncNumber(GetAltFunctionNumber<_Regs>, maskSda);
            _SdaPins::SetDriverType(_SdaPins::DriverType::OpenDrain, maskSda);
...
#endif //! ZHELE_PLATFORM_STM32_F4_I2C_H